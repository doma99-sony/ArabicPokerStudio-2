        ...
        <div className="mt-4 p-3 rounded-lg bg-black/30 border border-[#D4AF37]/20">
          <div className="flex justify-between items-center">
            <div>
              ...
              <div className="font-bold">{bets.length}</div>
            </div>
            <div>
              <div className="text-xs text-gray-400">إجمالي الرهانات</div>
              <div className="font-bold text-[#D4AF37]">{formatChips(bets.reduce((sum, bet) => sum + bet.amount, 0))}</div>
            </div>
            <div>
              <div className="text-xs text-gray-400">المجموع للجمع</div>
              <div className="font-bold text-green-500">{formatChips(
                bets
