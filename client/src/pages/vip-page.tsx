  ...
  const vipLevels: VIPLevel[] = [
    ...
    },
    {
      ...
      benefits: [
        ...
        `رقاقات إضافية يومية: ${formatChips(25000)}`,
        "دعم أولوية متميز",
        "رموز تعبيرية خاصة في الدردشة",
        "طاولات VIP حصرية"
      ],
    ...
    },
    {
      ...
      benefits: [
        ...
        `رقاقات إضافية يومية: ${formatChips(50000)}`,
        "دعم أولوية فائق",
        "رموز تعبيرية خاصة في الدردشة",
        "طاولات VIP حصرية",
        "مكافآت أسبوعية خاصة"
    ...
    },
    {
      ...
      benefits: [
        ...
        `رقاقات إضافية يومية: ${formatChips(100000)}`,
        "دعم أولوية VIP",
    ...
    },
    {
      ...
      benefits: [
        ...
        `رقاقات إضافية يومية: ${formatChips(250000)}`,
        "دعم VIP شخصي",
        "جميع الرموز التعبيرية الخاصة",
        "طاولات VIP 6 حصرية",
        "مكافآت أسبوعية خاصة",
    ...
    },
    {
      ...
      benefits: [
        ...
        `رقاقات إضافية يومية: ${formatChips(500000)}`,
        "دعم VIP شخصي ممتاز",
    ...
    },
    {
      ...
      benefits: [
        ...
        `رقاقات إضافية يومية: ${formatChips(1000000)}`,
        "دعم العضو البلاتيني",
        "كل المميزات المتاحة",
